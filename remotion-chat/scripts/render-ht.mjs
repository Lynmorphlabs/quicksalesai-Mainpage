...
await renderMedia({ composition, serveUrl: bundled, codec: "h264", outputLocation: "/dev-server/src/assets/feature-human-takeover.mp4", puppeteerInstance: browser, muted: true, concurrency: 1 });
