...
const features = [
  { img: aiAgentVideo, isVideo: true, title: "AI WhatsApp Agent", titleSuffix: "(Text/Voice/Multi-lingual recognition)", subtitle: "Your 24/7 sales rep on WhatsApp", desc: "Replies to customers instantly, answers questions, qualifies leads, and closes deals — automatically, even while you sleep. Reads and shares files and documents too." },
