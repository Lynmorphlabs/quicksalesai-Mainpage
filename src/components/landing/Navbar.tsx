...
export const Navbar = () => (
  <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-background/70 border-b border-border/40">
    <nav className="container flex items-center justify-between h-16">
      <a href="#" className="relative flex items-center h-16 w-48 md:w-64">
        <img src={logo} alt="Quicksales.ai logo" className="absolute left-0 top-1/2 -translate-y-1/2 h-[12.5rem] md:h-40 w-auto max-w-none" />
      </a>
