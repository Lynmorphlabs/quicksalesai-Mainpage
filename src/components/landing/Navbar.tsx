...
export const Navbar = () => (
  <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-background/70 border-b border-border/40">
    <nav className="container flex items-center justify-between h-16">
      <a href="#" className="flex items-center gap-2 font-bold text-lg relative">
        <img src={logo} alt="Quicksales.ai logo" className="h-[12.5rem] md:h-40 w-auto absolute left-0 top-1/2 -translate-y-1/2" />
      </a>
