...
import antGroupLogo from "@/assets/logos/ant-group-hd.png.asset.json";
...
const logos: { src: string; alt: string; className: string }[] = [
  ...
  { src: huaweiLogo.url, alt: "Huawei", className: "h-12 sm:h-14" },
  ...
  { src: hpLogo.url, alt: "HP", className: "h-16 sm:h-20" },
  { src: pgLogo.url, alt: "P&G", className: "h-16 sm:h-20" },
  ...
  { src: shopeeLogo.url, alt: "Shopee", className: "h-16 sm:h-20" },
  ...
  { src: galaLogo.url, alt: "Gala", className: "h-14 sm:h-16" },
  { src: bitmartLogo.url, alt: "BitMart", className: "h-14 sm:h-16" },
];
